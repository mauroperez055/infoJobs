...
const { navigateTo } = useRouter();
  ...
  const handleSearch = (event) => {
    ...
    const formData = new FormData(event.target); //recupero todos los datos del formulario
    const searchTerm = formData.get('search');
    
    const url = searchTerm
      ? `/search?text=${encodeURIComponent(searchTerm)}` 
      //encodeURIComponent codifica correctamente los espacios por si lo que buscamos contiene espacios
      : '/search' 
